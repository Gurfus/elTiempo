...
L.Control.Rainviewer = L.Control.extend({
  ...
  load: function (map) {
    ...
    this.startstopButton = L.DomUtil.create('a', 'leaflet-control-rainviewer-startstop ', this.controlContainer)
    ...
    L.DomEvent.on(this.closeButton, 'click', t.unloadui, this)
